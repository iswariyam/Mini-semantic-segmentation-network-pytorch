...
class UNet(nn.Module):
    ...
    def encoder(self, x):
        ...
        x : Float tensor
            ...
            C - 3
            H, W - 512 for low resolution images and 1024 for full
            resolution images
    ...
    def decoder(self, x):
        ...
        -------
        Float tensor
            Returns an upsampled feature map of
            size BATCH_SIZE x C x H/4 x W/4.
            C - No. of classes of objects in the image. (4 classes)
            Here we have 3 classes (Ball, field, field lines) + 1 background
            class. The decoder outputs an image whose height and width
            is reduced 4 times.
    ...
    def forward(self, x):
        ...
        x : Float tensor
            Input image tensor to the model of size BATCH_SIZE x C x H x W.
            C - 3
            H, W - 512 for low resolution images and 1024 for
